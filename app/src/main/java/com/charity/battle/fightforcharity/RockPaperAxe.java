...
/**
 * Created by JacobTsafatinos on 15-07-18.
 */
public class RockPaperAxe {
    private User user;
    ...
    private class User {
        ...
        public Move getMove() {
            ...
            if (firstLetter == 'R' || firstLetter == 'P' || firstLetter == 'A') {
    ...
    public static void main(String[] args) {
        RockPaperAxe game = new RockPaperAxe();
        game.startGame();
    }
}